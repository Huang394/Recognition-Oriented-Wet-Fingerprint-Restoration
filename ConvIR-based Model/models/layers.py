...
class dynamic_filter(nn.Module):
    ...
    def forward(self, x):
        ...
        #print('low filter: ', low_filter.shape)
        ...
        n, c, h, w = x.shape
        #print(c) 
        #print('pad: ',self.pad(x).shape)
        #print('unfold: ', F.unfold(self.pad(x), kernel_size=self.kernel_size, dilation=self.dilation).reshape(n, self.group, c//self.group, self.kernel_size**2, h*w).shape)
        ...
        #print('low filter: ',low_filter.shape)
        #print((x * low_filter).shape)
        #print('sum: ',torch.sum(x * low_filter, dim=3).shape)
        ...
        #print('out: ', (out_low + out_high).shape)
